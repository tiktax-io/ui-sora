...
/**
 * This is an internal helper component for rendering custom or Sora icons
 * Box props are applied to the outer Box container, and Sora icon-specific props are added to the icon element.
 */
...
IconWrapper.propTypes = {
  ...
  /**
   * The icon component - whether an Sora icon or a custom icon node:
   *
