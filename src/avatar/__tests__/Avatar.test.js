...
describe('Avatar', () => {
  ...
  it('should render a square if the shape is square', () => {
    ...
    expect(screen.getByTitle('Alan Turing')).toHaveStyle('border-top-right-radius: 8px')
  })

  it('should render the color when specified', () => {
    render(<Avatar name="Alan Turing" color="green" />)
    expect(screen.getByTitle('Alan Turing')).toHaveStyle('background-color: rgb(229, 251, 235)')
  })
})
