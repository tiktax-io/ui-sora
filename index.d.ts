...
export interface ButtonOwnProps {
  ...
  isActive?: boolean
  /**
   * Sets an icon before the text. Can be any icon from Sora or a custom icon library.
   */
  iconBefore?: React.ElementType | JSX.Element | null | false
  /**
   * Sets an icon after the text. Can be any icon from Sora or a custom icon library.
   */
...
export interface ListItemOwnProps extends TextOwnProps {
   ...
   * See Sora `Icon` for documentation.
   */
  icon?: React.ElementType | JSX.Element | null | false
  /**
...
/** @deprecated This component will be renamed to Pulsar in the next major version of Sora */
...
/** @deprecated This component will be removed in the next major version of Sora */
...
export interface TextDropdownButtonOwnProps {
  ...
  disabled?: boolean
  /**
   * An Sora icon or custom icon node. By default it uses CaretDownIcon
   */
  icon?: React.ElementType | JSX.Element | null | false
  /**
   * Class name passed to the button.
